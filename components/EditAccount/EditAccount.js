        ...
        <div className="col-12 mb-4">
          ...
          <input
            ...
            {...register('userName', {
              ...
              minLength: { value: 4, message: '* El nombre de usuario de contener entre 4 y 10 caracteres' },
              maxLength: { value: 10, message: '* El nombre de usuario de contener entre 4 y 10 caracteres' },
            })}
          />
